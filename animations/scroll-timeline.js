!(function () {
  ...
  function f(e) {
    if (e instanceof N) {
      var t = e.subject;
      t && 'none' != getComputedStyle(t).display ? h(e, w(t)) : h(e, null);
    } else
      !(function (e) {
        var t = s.get(e);
  ...
  function y(e, t) {
    return 'root' == e ? document.scrollingElement : w(t);
  }
  function T(e) {
  ...
  function x(e, t) {
    ...
    return 'inactive' === e.phase
      ? null
      : e instanceof N
      ? E(t, e.source, e.subject, n.axis, n.inset)
      : null;
  }
  ...
  function O(e) {
    (e.readyPromise = new A()),
      requestAnimationFrame(function () {
        null !== e.timeline.currentTime && G(e);
      });
  }
  function L() {
  ...
  function U(e) {
    ...
    var t = _(e, e.timeline.currentTime);
  ...
  function H(e, t) {
    if (!e.timeline) return null;
    var n = _(e, e.timeline.currentTime);
    return null == n ? null : n - t / e.animation.playbackRate;
  }
  function F(e, t, n) {
    if (e.timeline) {
      var i = t ? _(e, e.proxy.currentTime) : U(e);
      if (i && null != e.startTime && !e.proxy.pending) {
        ...
        r > 0 && i >= a
          ...
          : 0 != r &&
            (t && null !== e.holdTime && (e.startTime = H(e, e.holdTime)),
            (e.holdTime = null));
      }
      K(e),
        (e.previousCurrentTime = _(e, e.proxy.currentTime)),
        'finished' == e.proxy.playState
          ? (e.finishedPromise || (e.finishedPromise = new A()),
            'pending' == e.finishedPromise.state &&
              (n
                ? j(e)
  ...
  function K(e) {
    if (e.timeline)
      if (null !== e.startTime) {
        ...
        if (null == t) return;
        q(e, (_(e, t) - e.startTime) * e.animation.playbackRate);
  ...
  function B(e, t) {
    if (e.timeline) {
      ...
      null != r && ((e.startTime = r), (e.holdTime = null), D(e)),
        p(e.timeline, e.animation, Q.bind(e.proxy)),
  ...
  function Q(e) {
    ...
    if (null != e) {
      ...
      ('running' != n && 'finished' != n) ||
        (q(t, (_(t, e) - _(t, this.startTime)) * this.playbackRate),
  ...
  var X = new WeakMap(),
    Y = (function () {
      function e(e, t, n) {
        void 0 === n && (n = {});
        var i = e instanceof P ? e : new P(e, a),
          r = t instanceof v,
          a = r ? void 0 : t;
        X.set(this, {
          animation: i,
          ...
          effect: null,
          animationRange:
            t instanceof ViewTimeline ? ee(n['animation-range']) : null,
          proxy: this,
        });
      }
      var n = e.prototype;
      return (
        (n.finish = function () {
          ...
          if (e.timeline) {
            ...
            D(e);
            var i = t < 0 ? 0 : n;
            this.currentTime = W(e, i);
            var r = _(e, e.timeline.currentTime);
            null === e.startTime &&
              null !== r &&
        ...
        (n.reverse = function () {
          var e = X.get(this),
            t = V(e),
            n = e.resetCurrentTimeOnResume ? null : _(e, this.currentTime),
            i = Infinity == z(e),
            r = 0 != t && (t < 0 || n > 0 || !i);
          if (!e.timeline || !r)
            return (
            ...
            if (!t.readyPromise || 'pending' != t.readyPromise.state)
              switch (this.playState) {
                ...
                case 'paused':
                  ...
                  break;
                case 'finished':
                  var n = _(t, t.timeline.currentTime),
                    i =
                      null !== n
        ...
        (n.addEventListener = function (e, t, n) {
          X.get(this).animation.addEventListener(e, t, n);
        }),
        (n.removeEventListener = function (e, t, n) {
          X.get(this).animation.removeEventListener(e, t, n);
        }),
        (n.dispatchEvent = function (e) {
          X.get(this).animation.dispatchEvent(e);
        }),
        t(e, [
          {
            key: 'effect',
                      ...
                      var t = e.animation.effect,
                        ...
                        i = {
                          apply: function (n) {
                            ...
                            var i = n.apply(t);
                            if (e.timeline) {
                              (i.localTime = W(e, i.localTime)),
                                (i.endTime = W(e, i.endTime)),
                                (i.activeDuration = W(e, i.activeDuration));
                              var r = z(e);
                              (i.duration = r
                                ? CSS.percent(
                                    (100 *
                            ...
                            return (
                              e.timeline instanceof ViewTimeline &&
                                ((o = (function (e) {
                                  ...
                                  return I(e.timeline, t.rangeName, t.offset);
                                })(e)),
                                (l = (function (e) {
                                  if (!(e.timeline instanceof ViewTimeline))
                                    return 0;
                                  ...
                                  return (
                                    1 - I(e.timeline, t.rangeName, t.offset)
                                  );
                                })(e)),
                                (u = !0)),
                              (null === s.duration ||
            ...
            set: function (e) {
              (X.get(this).animation.effect = e), (details.effect = null);
            },
          },
          {
            key: 'timeline',
            ...
            set: function (e) {
              ...
              if (t != e) {
                ...
                if ((l && d(r.timeline, r.animation), s)) {
                  (r.timeline = e), D(r);
                  var c = r.animation.playbackRate >= 0 ? 0 : z(r);
                  switch (n) {
                    case 'running':
                    case 'finished':
                      (r.startTime = c),
                        p(r.timeline, r.animation, Q.bind(this));
                      break;
                    case 'paused':
                      (r.resetCurrentTimeOnResume = !0),
                        (r.startTime = null),
                        (r.holdTime = _(r, CSS.percent(100 * o)));
                      break;
                    default:
                ...
                if ((d(r.timeline, r.animation), (r.timeline = null), l))
                  switch (
                    (null !== i && (r.animation.currentTime = o * z(r)), n)
                  ) {
                    case 'paused':
                      r.animation.pause();
                      break;
          ...
          },
          {
            ...
            get: function () {
              var e = X.get(this);
              return e.timeline ? W(e, e.startTime) : e.animation.startTime;
            },
            set: function (e) {
              var t = X.get(this);
              if (((e = _(t, e)), t.timeline)) {
                null == _(t, t.timeline.currentTime) &&
                  null != t.startTime &&
                  ((t.holdTime = null), K(t));
                var n = _(t, this.currentTime);
                D(t),
                  (t.startTime = e),
          ...
          },
          {
            ...
            get: function () {
              var e = X.get(this);
              return e.timeline
                ? W(e, null != e.holdTime ? e.holdTime : U(e))
                : e.animation.currentTime;
            },
            set: function (e) {
              var t = X.get(this);
              if (((e = _(t, e)), t.timeline && null != e)) {
          ...
          },
          {
            key: 'playbackRate',
            get: function () {
              return X.get(this).animation.playbackRate;
            },
            set: function (e) {
              var t = X.get(this);
              if (t.timeline) {
          ...
          },
          {
            ...
            get: function () {
              ...
              if (
                ...
                return 'paused';
              if (null != t) {
                if (e.animation.playbackRate > 0 && t >= z(e))
                  return 'finished';
          ...
          },
          {
            key: 'replaceState',
            get: function () {
              return X.get(this).animation.pending;
            },
          },
          {
            key: 'pending',
          ...
          },
          {
            key: 'id',
            get: function () {
              return X.get(this).animation.id;
            },
            set: function (e) {
              X.get(this).animation.id = e;
            },
          },
          {
            key: 'onfinish',
            get: function () {
              return X.get(this).animation.onfinish;
            },
            set: function (e) {
              X.get(this).animation.onfinish = e;
            },
          },
          {
            key: 'oncancel',
            get: function () {
              return X.get(this).animation.oncancel;
            },
            set: function (e) {
              X.get(this).animation.oncancel = e;
            },
          },
          {
            key: 'onremove',
            get: function () {
              return X.get(this).animation.onremove;
            },
            set: function (e) {
              X.get(this).animation.onremove = e;
            },
          },
          {
            key: 'finished',
          ...
          },
          {
            ...
            get: function () {
              ...
              return e.timeline
                ? (e.readyPromise ||
                    ((e.readyPromise = new A()), e.readyPromise.resolve(this)),
  ...
  function $(e, t) {
    ...
    if (e instanceof Object)
      null != e.rangeName && (n = e.rangeName),
        void 0 !== e.offset && (i = e.offset);
    else {
      var r = e.split(' ');
      (n = r[0]), 2 == r.length && (i = r[1]);
    }
    if (!R.includes(n)) throw TypeError('Invalid range name');
  ...
  function te(e, t) {
    ...
    var i = C.apply(this, [e, t]),
      r = new Y(i, n);
    return (
      n instanceof v &&
        (i.pause(),
        n instanceof ViewTimeline &&
          (X.get(r).animationRange = {
            start: $(t.rangeStart, J()),
            end: $(t.rangeEnd, Z()),
          }),
        r.play()),
      r
      ...
      return (
        ...
        (t.parseScrollTimeline = function (e) {
          ...
          this.eatWhitespace(e),
            ...
            this.eatWhitespace(e);
          for (
            var i = { name: n, source: 'auto', axis: void 0 };
            '}' !== this.peek(e);
          ...
          if (n || i) {
            ...
            if (n)
              for (
                ...
                var u = { selector: e.selector, name: '' };
                1 == parts.length
                  ? (u.name = parts[0])
                  : 2 == parts.length &&
                    (ie.includes(parts[0])
            ...
            if (i)
              for (
                ...
                m < a.length
                  ? (a[m].name = c[m])
                  : a.push({ selector: e.selector, name: c[m] });
            var f = [];
            if (r) {
              var h = this.extractMatches(
                e.block.contents,
            ...
            for (var d = 0; d < a.length; d++)
              f.length && (a[d].axis = f[d % a.length]);
          ...
          if (n || i) {
            ...
            if (n)
              for (
                ...
                var c = { selector: e.selector, name: '', inset: null };
                1 == parts.length
                  ? (c.name = parts[0])
                  : 2 == parts.length &&
                    (ie.includes(parts[0])
            ...
            for (var v = 0; v < o.length; v++)
              h.length && (o[v].inset = h[v % o.length]),
                d.length && (o[v].axis = d[v % o.length]);
        ...
        (t.parseAnonymousTimeline = function (e) {
          ...
          return (
            t[1].split(' ').forEach(function (e) {
              ie.includes(e) ? (n.axis = e) : re.includes(e) && (n.source = e);
            }),
            n
          );
        }),
  ...
  function oe(e, t, n, i, r, a) {
    return M(E(e, t, n, i, r), a, E('cover', t, n, i, r));
  }
  !(function () {
    if (
      !(function () {
              ...
              if (!i.has(n.animationName)) {
                ...
                i.set(
                  ...
                  r && r.timeline && n.timeline != r.timeline
                    ? new Y(n, r.timeline, r.animOptions)
                    : null
                );
              }
      ...
      if (!Reflect.defineProperty(window, 'Animation', { value: Y }))
